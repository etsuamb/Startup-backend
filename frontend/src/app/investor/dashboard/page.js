			...
			<div className="flex-grow flex flex-col overflow-hidden">
				<header className="flex justify-between items-center px-8 py-4 bg-white border-b border-gray-100 z-10 shrink-0">
					...
					<div className="flex items-center gap-5">
						<Link href="/investor/messages" className="text-gray-400 hover:text-gray-600 transition relative">
							<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.9 9.9 0 01-4-.8L3 20l.8-3.2A7.3 7.3 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
							</svg>
						</Link>
						...
						<div className="flex items-center gap-3">
							<div className="w-8 h-8 rounded-full bg-[#0a4d3c] text-white flex items-center justify-center text-xs font-bold shrink-0">
